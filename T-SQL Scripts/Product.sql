...
CREATE TABLE [dbo].[Products](
    ...
    [SellingCurrency2Id] [int] Null Constraint FK_Product_SellingCurrency2Id Foreign Key References [dbo].[Currencies]([Id]),
    ...
    [BuyingCurrency2Id] [int] Null Constraint FK_Product_BuyingCurrency2Id Foreign Key References [dbo].[Currencies]([Id]),
    [LicensorPrice] [decimal](18, 4) Null,
    [LicensorCurrencyId] [int] Null Constraint FK_Product_LicensorCurrencyId Foreign Key References [dbo].[Currencies]([Id]),
