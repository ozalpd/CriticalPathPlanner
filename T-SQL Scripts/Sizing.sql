...
CREATE TABLE [dbo].[Sizings](
    ...
    [ModifierId] [VarChar](48) Not Null Constraint FK_Sizing_ModifierId Foreign Key References [dbo].[AspNetUsers]([Id]),
    [ModifierIp] [VarChar](48) Not Null,
    [CreateDate] [DateTime] Not Null Default GetDate(),
    [CreatorId] [VarChar](48) Not Null Constraint FK_Sizing_CreatorId Foreign Key References [dbo].[AspNetUsers]([Id]),
