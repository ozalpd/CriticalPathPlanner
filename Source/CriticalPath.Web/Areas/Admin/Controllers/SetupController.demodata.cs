    ...
    public partial class SetupController : BaseController
    {
        ...
        private async Task SeedCustomers(StringBuilder sb)
        {
            ...
            foreach (var item in customers)
            {
                ...
                item.DiscountRate = GetRandomPrice(4, 13);
                i++;
            ...
            Supplier[] suppliers = {
             ...
             new Supplier() {
                    ...
                    Manufacturers = {
                     new Manufacturer() {
                            ...
                            ManufacturerCode = "GEEKOLOGY-2576",
                            CountryId=90,
                            City = "Idledale",
             ...
             new Supplier() {
                    ...
                    Manufacturers = {
                     new Manufacturer() {
                            ...
                            ManufacturerCode = "COLUMELLA-693",
                            City = "Gibsonia",
                     ...
                     new Manufacturer() {
                            ...
                            ManufacturerCode = "HOMETOWN-8865",
                            CountryId=90,
                            City = "Malo",
             ...
             new Supplier() {
                    ...
                    Manufacturers = {
                     new Manufacturer() {
                            CompanyName = "Ontality",
                            ManufacturerCode = "ONTALITY-1766",
                            City = "Marshall",
             ...
             new Supplier() {
                    ...
                    Manufacturers = {
                     ...
                     new Manufacturer() {
                            ...
                            ManufacturerCode = "ZILIDIUM-7035",
                            CountryId=90,
                            City = "Lumberton",
             ...
             new Supplier() {
                    ...
                    Manufacturers = {
                     ...
                     new Manufacturer() {
                            ...
                            ManufacturerCode = "ROTODYNE-6766",
                            CountryId=90,
                            City = "Rowe",
                     ...
                     new Manufacturer() {
                            ...
                            ManufacturerCode = "ZILLANET-1908",
                            CountryId=90,
                            City = "Sparkill",
        ...
        private decimal GetRandomPrice(int minPrice, int maxPrice)
        {
            Random rnd = new Random();
            if (maxPrice > 0)
                return ((decimal)rnd.Next((minPrice * 20), (maxPrice * 20))) / 20m;
            else
                return 0m;
        }
